...
import { FormAvaliacao } from '@/features/avaliacoes/components/FormAvaliacao'
...
export default function NovaAvaliacaoPage() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="mb-5">
        <h1 className="text-lg font-semibold text-gray-900">Nova avaliação</h1>
        <p className="text-sm text-gray-500 mt-0.5">{paciente?.nome}</p>
      </div>
      <FormAvaliacao pacienteId={id!} />
    </div>
  )
}
